...
## 6. 동명(同名) 국가·지명의 소급 구분
- 같은 이름의 국가·지명이 시대별로 다르게 표기되면, 흔히 **계승 이전 국가와 당대 현재 국가를 소급
  구분**하는 명명 장치다 — 무관한 별개 실체라는 뜻이 아니다.
- 원문 관행 예: 사서가 \`前朝鮮\`(단군)·\`後朝鮮\`(기자)·\`衛滿\`을 명시 구분하고 \`三朝鮮\`을 말한다
  (현대 통용 '古朝鮮'은 소급 라벨). \`高句麗\`(전칭)와 \`高麗\`(축약)도 같은 축 — 중국 정사가 5세기
  (423 CE)에 그 국가를 이미 \`高麗國\`으로 기록해, 918년 고려 왕조보다 앞선다.
- 규율: 동명 국가를 무비판적으로 '별개'로도, '동일'로도 단정하지 말라. \`search_han\`으로 전칭·축약·
  前/後/古 표기를 함께 찾고, \`cluster\`·지도 교차로 계승·동일성 **가능성만** 제시한다. 판단은 연구자.
